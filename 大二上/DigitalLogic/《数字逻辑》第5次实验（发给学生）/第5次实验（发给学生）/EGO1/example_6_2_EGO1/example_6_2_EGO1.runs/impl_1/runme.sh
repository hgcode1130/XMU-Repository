...
HD_PWD='C:/DigitalLogic/EGO1/example_6_2_EGO1/example_6_2_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_6_2_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_6_2_exe.tcl -notrace
