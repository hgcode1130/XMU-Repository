...
HD_PWD='C:/DigitalLogic/EGO1/example_4_1_EGO1/example_4_1_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_4_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example_4_1.tcl
