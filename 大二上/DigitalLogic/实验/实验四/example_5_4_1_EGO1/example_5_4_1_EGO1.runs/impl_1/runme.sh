...
HD_PWD='D:/DigitalLogic/EGO1/example_5_4_1_EGO1/example_5_4_1_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_5_4_1_EGO1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_5_4_1_EGO1.tcl -notrace
