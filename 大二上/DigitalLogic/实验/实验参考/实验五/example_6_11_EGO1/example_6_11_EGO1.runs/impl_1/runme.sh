...
HD_PWD='D:/DigitalLogic/ACE1/Test5_Design/example_6_11_ACE1/example_6_11_ACE1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_6_11_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_6_11_exe.tcl -notrace
