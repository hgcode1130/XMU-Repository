...
HD_PWD='D:/DigitalLogic/ACE1/Test5_Design/example_6_4_1_ACE1/example_6_4_1_ACE1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_6_4_1_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_6_4_1_exe.tcl -notrace
