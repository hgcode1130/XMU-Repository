...
HD_PWD='D:/DigitalLogic/ACE1/Test4_Design/example_5_4_ACE1/example_5_4_ACE1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_5_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example_5_4.tcl
