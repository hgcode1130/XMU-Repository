...
HD_PWD='D:/DigitalLogic/ACE1/Test4_Design/example_5_4_ACE1/example_5_4_ACE1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_5_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_5_4.tcl -notrace
