...
HD_PWD='C:/DigitalLogic/EGO1/segment_display_decoder_EGO1/segment_display_decoder_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segment_display_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segment_display_decoder.tcl -notrace
