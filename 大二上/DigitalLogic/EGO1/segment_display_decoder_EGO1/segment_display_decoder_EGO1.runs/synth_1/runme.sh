...
HD_PWD='C:/DigitalLogic/EGO1/segment_display_decoder_EGO1/segment_display_decoder_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segment_display_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segment_display_decoder.tcl
