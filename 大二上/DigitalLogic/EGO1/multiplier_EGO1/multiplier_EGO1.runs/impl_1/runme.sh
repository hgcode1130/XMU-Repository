...
HD_PWD='D:/DigitalLogic/EGO1/multiplier_EGO1/multiplier_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_EGO1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplier_EGO1.tcl -notrace
