...
HD_PWD='D:/DigitalLogic/EGO1/multiplier_EGO1/multiplier_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplier_EGO1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplier_EGO1.tcl
