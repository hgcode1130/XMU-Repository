...
HD_PWD='C:/DigitalLogic/EGO1/example_5_1_2_EGO1/example_5_1_2_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_5_1_2_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_5_1_2_exe.tcl -notrace
