...
HD_PWD='C:/DigitalLogic/EGO1/7400_2_EGO1/7400_2_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ttl7400.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ttl7400.tcl -notrace
