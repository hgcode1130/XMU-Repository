...
HD_PWD='C:/DigitalLogic/EGO1/7400_2_EGO1/7400_2_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ttl7400.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ttl7400.tcl
