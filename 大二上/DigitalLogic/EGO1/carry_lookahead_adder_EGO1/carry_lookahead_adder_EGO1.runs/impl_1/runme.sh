...
HD_PWD='C:/DigitalLogic/EGO1/carry_lookahead_adder_EGO1/carry_lookahead_adder_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_lookahead_adder_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source carry_lookahead_adder_exe.tcl -notrace
