...
HD_PWD='C:/DigitalLogic/EGO1/carry_lookahead_adder_EGO1/carry_lookahead_adder_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_lookahead_adder_exe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carry_lookahead_adder_exe.tcl
