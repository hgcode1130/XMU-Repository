...
HD_PWD='D:/DigitalLogic/EGO1/E_CLOCK/E_CLOCK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log E_CLOCK.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source E_CLOCK.tcl -notrace
