...
HD_PWD='D:/DigitalLogic/EGO1/E_CLOCK/E_CLOCK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log E_CLOCK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source E_CLOCK.tcl
