...
HD_PWD='C:/DigitalLogic/EGO1/example_5_1_3_EGO1/example_5_1_3_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_5_1_3_exe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example_5_1_3_exe.tcl
