...
HD_PWD='C:/DigitalLogic/EGO1/74193_EGO1/74193_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ttl74193_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ttl74193_exe.tcl -notrace
