...
HD_PWD='C:/DigitalLogic/EGO1/m_s_rs_flip_flop_EGO1/m_s_rs_flip_flop_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log m_s_rs_flip_flop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source m_s_rs_flip_flop.tcl -notrace
