...
HD_PWD='C:/DigitalLogic/EGO1/m_s_rs_flip_flop_EGO1/m_s_rs_flip_flop_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m_s_rs_flip_flop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m_s_rs_flip_flop.tcl
