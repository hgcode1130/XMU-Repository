...
HD_PWD='C:/DigitalLogic/EGO1/74138_EGO1/74138_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ttl74138_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ttl74138_exe.tcl -notrace
