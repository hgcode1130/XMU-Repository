...
HD_PWD='C:/DigitalLogic/EGO1/example_6_1_1_EGO1/example_6_1_1_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_6_1_1_exe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example_6_1_1_exe.tcl
