...
HD_PWD='C:/DigitalLogic/EGO1/demux8_EGO1/demux8_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demux8_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demux8_exe.tcl -notrace
