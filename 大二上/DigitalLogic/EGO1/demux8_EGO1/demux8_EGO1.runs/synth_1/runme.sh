...
HD_PWD='C:/DigitalLogic/EGO1/demux8_EGO1/demux8_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux8_exe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux8_exe.tcl
