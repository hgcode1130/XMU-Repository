...
HD_PWD='C:/DigitalLogic/EGO1/example_4_12a_EGO1/example_4_12a_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_4_12a.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_4_12a.tcl -notrace
