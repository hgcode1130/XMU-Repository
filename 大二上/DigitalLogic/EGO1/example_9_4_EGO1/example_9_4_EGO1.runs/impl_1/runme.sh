...
HD_PWD='C:/DigitalLogic/EGO1/example_9_4_EGO1/example_9_4_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_9_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_9_4.tcl -notrace
