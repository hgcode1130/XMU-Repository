...
HD_PWD='C:/DigitalLogic/EGO1/serial_adder_EGO1/serial_adder_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serial_adder_exe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serial_adder_exe.tcl
