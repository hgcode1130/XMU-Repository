...
HD_PWD='C:/DigitalLogic/EGO1/serial_adder_EGO1/serial_adder_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serial_adder_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source serial_adder_exe.tcl -notrace
