...
HD_PWD='C:/DigitalLogic/EGO1/74290_EGO1/74290_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ttl74290_exe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ttl74290_exe.tcl -notrace
