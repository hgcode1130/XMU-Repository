...
HD_PWD='C:/DigitalLogic/EGO1/clk_jk_flip_flop_EGO1/clk_jk_flip_flop_EGO1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_jk_flip_flop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_jk_flip_flop.tcl -notrace
