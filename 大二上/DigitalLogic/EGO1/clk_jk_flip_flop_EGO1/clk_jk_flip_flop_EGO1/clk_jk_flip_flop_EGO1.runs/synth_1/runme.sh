...
HD_PWD='C:/DigitalLogic/EGO1/clk_jk_flip_flop_EGO1/clk_jk_flip_flop_EGO1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_jk_flip_flop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_jk_flip_flop.tcl
