...
QT_MOC_LITERAL(3, 23, 10), // "answerCall"
QT_MOC_LITERAL(4, 34, 6), // "handUp"
QT_MOC_LITERAL(5, 41, 4), // "call"
QT_MOC_LITERAL(6, 46, 8) // "phonenum"

    },
    "WorkerObject\0finished\0\0answerCall\0"
    "handUp\0call\0phonenum"
};
...
void WorkerObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        switch (_id) {
        case 0: { WorkerObject *_r = new WorkerObject();
            if (_a[0]) *reinterpret_cast<QObject**>(_a[0]) = _r; } break;
        default: break;
        }
    } else if (_c == QMetaObject::InvokeMetaMethod) {
        WorkerObject *_t = static_cast<WorkerObject *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finished(); break;
        case 1: _t->answerCall(); break;
        case 2: _t->handUp(); break;
        case 3: { int _r = _t->call((*reinterpret_cast< QString(*)>(_a[1])));
        ...
        {
            using _t = void (WorkerObject::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerObject::finished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WorkerObject::staticMetaObject = {
